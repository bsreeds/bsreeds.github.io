...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR neongreen][B]Neo[/B][/COLOR]Wizard'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Neo[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR cyan][B]Neo[/B][/COLOR]Wizard'
