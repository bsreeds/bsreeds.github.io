...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR purple][B]Fusion[/B][/COLOR]Wizard'
BUILDERNAME = 'FusionWizard'
EXCLUDES = [ADDON_ID, 'repository.fusion']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
#BUILDFILE = 'https://triumphal-ocean.000webhostapp.com/Wizard/builds.txt'
BUILDFILE = 'https://www.dropbox.com/scl/fi/ywksh985rxg460rsbu2ur/builds.txt?rlkey=bp8ej0rvoiqn7ofdrs9nswrxt&st=gs3wdpky&dl=0'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Fuse[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Fusion Wizard.\n\nContact us on Github at http://www.github.com/bsreeds/plugin.program.neowizard/'
...
NOTIFICATION = 'https://triumphal-ocean.000webhostapp.com/Wizard/notifications.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR cyan][B]Fusion[/B][/COLOR]Wizard'
